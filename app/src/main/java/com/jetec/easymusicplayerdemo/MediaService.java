...
public class MediaService extends Service {
    ...
    public void onCreate() {
        ...
        if (mAct.butt<=2){
            //angry, disgust, fear
            mediaPlayer = MediaPlayer.create(this,R.raw.music_angry);
        }
        else if (mAct.butt ==3)
        {
            //happy, surprise
            mediaPlayer = MediaPlayer.create(this,R.raw.music_happy);
        }
        else if(mAct.butt ==4)
        {
            //sad
            mediaPlayer = MediaPlayer.create(this,R.raw.music_sad);
        }
        else
        {
            //nature
            mediaPlayer = MediaPlayer.create(this,R.raw.music_nature);
        }
